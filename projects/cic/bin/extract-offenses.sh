...
#
# This script extracts incident offense type from a criminal incident data instance.
#
# Inputs: 1) criminal incident data instance (provided as csv-separated file)
#
# Output: List of offenses
#
...
fieldNums="20 21 22 23"
[ $DEBUG ] && echo "*** DEBUG: $0: getting offense(s)..." >&2
